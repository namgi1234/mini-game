...
InfiniteRunner.draw = function(){
  ...
  if (window.innerHeight > 600) {
    ...
    this.fillText('RECORD: '+this.jumpCountRecord, this.width - (150 + (this.aceleration * 4)), 70 - (this.aceleration * 4));
    this.fillStyle = this.scoreColor;
    this.font = (12 + (this.aceleration * 3))+'pt Arial';
    this.fillText('JUMPS: '+this.jumpCount, this.width - (150 + (this.aceleration * 4)), 85);
  }
  
};

InfiniteRunner.resize = function() {};
document.querySelector('.controlls').style.display = 'block';
